...
namespace KenticoCloud.Engage.MVC
{
    /// <summary>
    /// Extension methods to provide access to Engage ids
    /// </summary>
    public static class HttpRequestBaseExtensions
    {
        ...
        public static string GetCurrentEngageUid(this HttpRequestBase request)
        {
        ...
        public static string GetCurrentEngageSid(this HttpRequestBase request)
        {
